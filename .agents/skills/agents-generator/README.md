...
**After**: Your agent has an `AGENTS.md` that matches what you _actually_ use — every command, convention, and architecture decision derived from your real `package.json`, config files, and directory structure.
